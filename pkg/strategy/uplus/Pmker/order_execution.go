...
type ExchangePmkionRouter struct {
	sessions  map[string]*ExchangeSession
	executors map[string]Pmkor
}

func (e *ExchangePmkionRouter) SubmitOrdersTo(ctx context.Context, session string, orders ...types.SubmitOrder) (types.OrderSlice, error) {
	...
	createdOrders, _, err := BatchPlace(ctx, es.Exchange, formattedOrders...)
	return createdOrders, err
}

func BatchRetryPlace(ctx context.Context, exchange types.Exchange, errIdx []int, submitOrders ...types.SubmitOrder) (types.OrderSlice, error) {
...
// BatchPlaceOrder
func BatchPlace(ctx context.Context, exchange types.Exchange, submitOrders ...types.SubmitOrder) (types.OrderSlice, []int, error) {
	var createdOrders types.OrderSlice
	var err error
	var errIndexes []int
...
func (e *ExchangePmkionRouter) CancelOrdersTo(ctx context.Context, session string, orders ...types.Order) error {
	if executor, ok := e.executors[session]; ok {
...
// ExchangePmkor is an order executor wrapper for single exchange instance.
//
//go:generate callbackgen -type ExchangePmkor
type ExchangePmkor struct {
...
func (e *ExchangePmkor) SubmitOrders(ctx context.Context, orders ...types.SubmitOrder) (types.OrderSlice, error) {
	...
	createdOrders, _, err := BatchPlace(ctx, e.Session.Exchange, formattedOrders...)
	return createdOrders, err
}

func (e *ExchangePmkor) CancelOrders(ctx context.Context, orders ...types.Order) error {
...
func (c *RiskController) ProcessOrders(session *ExchangeSession, orders ...types.SubmitOrder) (outOrders []types.SubmitOrder, errs []error) {
